    ...
    <div className="mx-auto max-w-xl">
      ...
      <form className="rounded-2xl bg-white p-5 shadow" onSubmit={submitGuess}>
        <label className="block">
          ...
          <input
            className="min-h-14 w-full rounded-2xl border border-slate-200 px-4 text-2xl font-bold outline-none transition focus:border-[#6aaecd] focus:ring-4 focus:ring-[#6aaecd]/20"
            type="number"
            min="1"
            max="100"
            inputMode="numeric"
      ...
      <div className="mt-5 rounded-2xl bg-[#fff0c7] p-5 text-center shadow">
